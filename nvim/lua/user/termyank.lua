...
function M.debug_enable()
  debug = true
  vim.notify("termyank debug: on", vim.log.levels.INFO)
end

function M.debug_disable()
  debug = false
  vim.notify("termyank debug: off", vim.log.levels.INFO)
end
...
function M.setup(user_opts)
  ...
  vim.api.nvim_create_user_command("TermYankDebugOn", M.debug_enable, {})
  vim.api.nvim_create_user_command("TermYankDebugOff", M.debug_disable, {})
end

M.setup({ text_objects_span_lines = true })
